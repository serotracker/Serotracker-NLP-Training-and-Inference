...
if __name__ == '__main__':
    ...
    train_file = open('./abstract_screen_demo/data/text_classification/covidence_backwards/train.tsv', 'w')
    dev_file = open('./abstract_screen_demo/data/text_classification/covidence_backwards/dev.tsv', 'w')
    test_file = open('./abstract_screen_demo/data/text_classification/covidence_backwards/test.tsv', 'w')
