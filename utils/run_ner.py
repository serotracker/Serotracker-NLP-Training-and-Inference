...
"""
Finetuning your BERT models for named entity recognition.
This script targets BlueBERT datasets released by NCBI.
https://github.com/ncbi-nlp/bluebert
https://github.com/ncbi-nlp/BLUE_Benchmark

In this script, we use metrics from:
https://github.com/ncbi-nlp/bluebert/blob/master/bluebert/conlleval.py
https://github.com/ncbi-nlp/bluebert/blob/master/bluebert/tf_metrics.py
...
from processors.utils_ner import (
    BC5CDRProcessor,
    CLEFEProcessor,
